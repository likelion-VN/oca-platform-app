...
const StudentViewCompany = () => {
  ...
  return (
    <>
      ...
      <ModalComponent
        open={state.openModalSendEmail}
        title="Send an Email to [Company Name]"
        centered
        className="modal-send-email-company"
        children={<SendEmailForm />}
        footer={
          <div className="footer-form-send-email">
            <ButtonComponent className="btn-edit-cancel" title="Cancel" />
            <ButtonComponent className="btn-edit-save" title="Send" />
          </div>
        }
      />
    </>
