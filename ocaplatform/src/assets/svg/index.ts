...
export { default as Company } from "./company-icon.svg";
export { default as Congratulation } from "./congratulation-icon.svg";
export { default as EditFormIcon } from "./edit-form-icon.svg";
